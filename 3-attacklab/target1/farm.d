...
000000000000000c <addval_273>:*mov
...
000000000000001a <setval_237>:*mov
...
000000000000002f <setval_426>:*mov
  2f:	c7 07 *48 *89 c7 90    	movl   $0x90c78948,(%rdi)
  35:	c3                   	retq   

0000000000000036 <getval_280>:*pop
...
0000000000000047 <getval_481>:*pop *mov
...
000000000000005b <addval_490>:*andb
...
0000000000000068 <setval_384>:*test
  68:	c7 07 81 d1 *84 c0    	movl   $0xc084d181,(%rdi)
  6e:	c3                   	retq   

000000000000006f <addval_190>:*mov
  6f:	8d 87 41 *48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax
  75:	c3                   	retq   

0000000000000076 <setval_276>:*or
  76:	c7 07 88 c2 *08 c9    	movl   $0xc908c288,(%rdi)
  7c:	c3                   	retq   

000000000000007d <addval_436>:*movl
...
000000000000009f <getval_159>:*mov*cmp
  9f:	b8 *89 d1 *38 c9       	mov    $0xc938d189,%eax
  a4:	c3                   	retq   

00000000000000a5 <addval_110>:*mov
...
00000000000000ba <getval_272>:*or
...
00000000000000e1 <setval_328>:*cmp
  e1:	c7 07 81 c2 *38 d2    	movl   $0xd238c281,(%rdi)
  e7:	c3                   	retq   

00000000000000e8 <setval_450>:*or
  e8:	c7 07 09 ce *08 c9    	movl   $0xc908ce09,(%rdi)
  ee:	c3                   	retq   

00000000000000ef <addval_358>:*mov
...
00000000000000fd <getval_169>:*andb
...
0000000000000111 <getval_472>:*andb
 111:	b8 8d ce *20 d2       	mov    $0xd220ce8d,%eax
 116:	c3                   	retq   

0000000000000117 <setval_350>:*mov
